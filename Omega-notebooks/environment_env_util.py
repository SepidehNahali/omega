...
__all__ = ['observe_rltaps', 'plot_observe', 'num_racks_cal', 'calc_speed_single', 'get_ret_asym',
...
def get_ret_asym(gradsize, gpu_request, numracks, ret_reducer):
...
def calc_job_minbatch_speed(job, gpus_per_rack, ret_reducer, singleormulti='multi',outdetails=False):
